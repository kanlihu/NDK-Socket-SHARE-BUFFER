...
#ifndef AHARDWAREBUFFER_IPC_CLIENT_ESUTIL_H
#define AHARDWAREBUFFER_IPC_CLIENT_ESUTIL_H
///
//  Includes
//
#include <stdlib.h>
...
struct ESContext
{
    ...
    struct AHardwareBuffer* h_buffer02;
...
#endif
#endif //AHARDWAREBUFFER_IPC_CLIENT_ESUTIL_H
